...
* run `dotnet fsdocs watch --eval` to spawn a watcher and dev server that hosts your docs on [http://localhost:8901/](http://localhost:8901/) (You currently will still have to refresh the page when you make changes to files)
